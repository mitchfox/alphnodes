    ...
    <section>
      <div className="pt-32 pb-12 md:pt-36 md:pb-20">
        <div className="px-4 sm:px-6">
          ...
          {/* Contact form */}
          <div className="relative flex items-center justify-center gap-10 before:h-px before:w-full before:border-b before:[border-image:linear-gradient(to_right,transparent,theme(colors.green.300/.8),transparent)1] dark:before:[border-image:linear-gradient(to_right,transparent,theme(colors.green.300/.16),transparent)1] before:shadow-sm before:shadow-white/20 dark:before:shadow-none after:h-px after:w-full after:border-b after:[border-image:linear-gradient(to_right,transparent,theme(colors.green.300/.8),transparent)1] dark:after:[border-image:linear-gradient(to_right,transparent,theme(colors.green.300/.16),transparent)1] after:shadow-sm after:shadow-white/20 dark:after:shadow-none mb-16 pb-3">
            ...
            <div className="grid md:grid-cols-3 gap-6 xl:gap-9 xl:mx-8 max-md:-mx-3">
              ...
              <div className="flex flex-col rounded-lg bg-gradient-to-tr from-white/70 to-white/50 dark:bg-gradient-to-b dark:from-gray-700/50 dark:to-gray-700/40 p-5">
                ...
                <div className="flex items-center space-x-2.5">
                  <svg
                    className="shrink-0 fill-green-500/80"
                    width={16}
                    height={16}
                    xmlns="http://www.w3.org/2000/svg"
                  >
