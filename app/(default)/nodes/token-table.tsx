                        ...
                        <tbody>
                            {nodeData.map((node, index) => (
                                <tr key={index} className="bg-white border-b dark:bg-neutral-800 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-600">
                                    ...
                                    <td className="px-6 py-4 text-neutral-600 dark:text-neutral-400">{node.clientVersion}</td>
                                    ...
                                    <td className="px-6 py-4 text-neutral-600 dark:text-neutral-400">{node.country}</td>
